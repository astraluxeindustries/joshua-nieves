...
export const Testimonials = () => {
  const reviews = [
    {
      text: "Joshua made the impossible possible. We had a complicated income situation, but he navigated it with ease. We are now in our dream home thanks to him!",
      author: "Michael & Jessica T.",
      type: "First-Time Buyers"
    },
    {
      text: "As a real estate investor, I need speed and reliability. Joshua delivers both every single time. His knowledge of the market is unmatched.",
      author: "David R.",
      type: "Real Estate Investor"
    },
    {
      text: "The communication was outstanding. I never had to guess where we were in the process. Highly recommend Joshua to anyone looking for a stress-free mortgage.",
      author: "Amanda L.",
