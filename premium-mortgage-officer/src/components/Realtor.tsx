    ...
    <section id="realtors" className="py-20 bg-slate-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-xl text-slate-600 mb-8 leading-relaxed">
          If you are a real estate professional in Las Vegas, I provide consistent communication, fast pre-approvals, and on-time closings to support your transactions and protect your reputation.
        </p>
